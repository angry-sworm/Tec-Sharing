...
* B+ 树的大小取决于每个节点的关键字和指针的数量，且每个非根节点都要保持至少半满的状态，所以对于一棵阶数为 m 的 B+ 树来说，其每一层所对应的最大节点数量如下图所示：
...
* **例如设置 N = 1999998，m = 199，代入上面的公式可以得到 3.9999 ≥ l，所以判断出该 B+ 树的最大高度不会大于 4 （l 从 0 开始索引）。**
